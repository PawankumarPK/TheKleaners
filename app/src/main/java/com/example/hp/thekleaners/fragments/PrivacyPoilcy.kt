...
import kotlinx.android.synthetic.main.fragment_privacy_poilcy.*

class PrivacyPoilcy : BaseNavigationFragment() {

    private val urlSearch = "http://thekleaners.com/privacy-policy.html"
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        return inflater.inflate(R.layout.fragment_privacy_poilcy, container, false)
